    ...
    <div className="auth-page page-enter">
      ...
      <div className="auth-card">
        <div className="auth-logo">
          <div style={{ width: 56, height: 56, borderRadius: 16, background: 'var(--gradient-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1rem', fontWeight: 900, color: '#fff', letterSpacing: '-0.03em', marginBottom: '0.75rem', boxShadow: 'var(--glow-primary)', margin: '0 auto 0.75rem', fontFamily: 'Geist, sans-serif' }}>AN</div>
          ...
          <>
            ...
            <form onSubmit={handleCredentials} noValidate>
              ...
              <p style={{ textAlign: 'center', fontSize: '0.8125rem', marginTop: '0.875rem' }}>
                <Link to="/forgot-password" style={{ color: 'var(--brand)', fontWeight: 600 }}>Forgot password?</Link>
              </p>
            </form>

            <p style={{ textAlign: 'center', fontSize: '0.875rem', color: 'var(--text-muted)', marginTop: '1.25rem' }}>
              Don't have an account?{' '}
              <Link to="/register" style={{ fontWeight: 700, color: 'var(--brand)' }}>Create one free</Link>
            </p>
          ...
          <form onSubmit={handleOtp} noValidate>
            <div className="alert alert-info" style={{ marginBottom: '1.25rem' }}>
              ...
              <div style={{ fontSize: '0.875rem' }}>
                ...
                We sent a 6-digit code to <strong style={{ color: 'var(--brand)' }}>{email}</strong>.<br />
